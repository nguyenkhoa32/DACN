...
// CHỨC NĂNG: Quản lý đặt sân, đồng bộ dữ liệu sân và lưu booking
// =========================================================
...
// 1. DỮ LIỆU CÁC SÂN GỐC (Fallback nếu Local Storage trống)
const COURTS_DATA = [
    // Hải Châu
    { id: 1, name: "Sân Hải Châu Premium A", type: "Thảm PVC", tickets: 5, open: "04:30", close: "22:00", image: "img/haichau1.png", district: "Hải Châu", price: "80.000", monthPrice: 600000, subCourts: [{ id: 1, tickets: 5 }, { id: 2, tickets: 5 }, { id: 3, tickets: 5 }, { id: 4, tickets: 5 }, { id: 5, tickets: 5 }] },
    { id: 2, name: "Sân Bồ Đề", type: "Thảm Su", tickets: 5, open: "05:00", close: "23:00", image: "img/haichau2.png", district: "Hải Châu", price: "80.000", monthPrice: 550000, subCourts: [{ id: 1, tickets: 5 }, { id: 2, tickets: 5 }, { id: 3, tickets: 5 }, { id: 4, tickets: 5 }, { id: 5, tickets: 5 }] },
    { id: 3, name: "Sân Nguyễn Văn Linh", type: "Sàn Gỗ", tickets: 5, open: "06:00", close: "21:00", image: "img/haichau3.png", district: "Hải Châu", price: "100.000", monthPrice: 750000, subCourts: [{ id: 1, tickets: 5 }, { id: 2, tickets: 5 }, { id: 3, tickets: 5 }, { id: 4, tickets: 5 }, { id: 5, tickets: 5 }] },
    { id: 4, name: "Sân 2/9 Club", type: "Thảm PVC", tickets: 5, open: "05:30", close: "23:30", image: "img/haichau4.png", district: "Hải Châu", price: "80.000", monthPrice: 650000, subCourts: [{ id: 1, tickets: 5 }, { id: 2, tickets: 5 }, { id: 3, tickets: 5 }, { id: 4, tickets: 5 }, { id: 5, tickets: 5 }] },
    { id: 5, name: "Sân Đà Nẵng Centre", type: "Thảm Su", tickets: 5, open: "05:00", close: "22:30", image: "img/haichau5.png", district: "Hải Châu", price: "80.000", monthPrice: 620000, subCourts: [{ id: 1, tickets: 5 }, { id: 2, tickets: 5 }, { id: 3, tickets: 5 }, { id: 4, tickets: 5 }, { id: 5, tickets: 5 }] },
    // Thanh Khê
    { id: 6, name: "Sân Thanh Khê 1", type: "Thảm PVC", tickets: 5, open: "05:00", close: "22:00", image: "img/thanhkhe1.png", district: "Thanh Khê", price: "80.000", monthPrice: 500000, subCourts: [{ id: 1, tickets: 5 }, { id: 2, tickets: 5 }, { id: 3, tickets: 5 }, { id: 4, tickets: 5 }, { id: 5, tickets: 5 }] },
    { id: 7, name: "Sân Thanh Khê 2", type: "Sàn Gỗ", tickets: 5, open: "06:00", close: "23:00", image: "img/thanhkhe2.png", district: "Thanh Khê", price: "100.000", monthPrice: 700000, subCourts: [{ id: 1, tickets: 5 }, { id: 2, tickets: 5 }, { id: 3, tickets: 5 }, { id: 4, tickets: 5 }, { id: 5, tickets: 5 }] },
    { id: 8, name: "Sân Hà Huy Tập", type: "Thảm Su", tickets: 5, open: "04:30", close: "21:30", image: "img/thanhkhe3.png", district: "Thanh Khê", price: "80.000", monthPrice: 550000, subCourts: [{ id: 1, tickets: 5 }, { id: 2, tickets: 5 }, { id: 3, tickets: 5 }, { id: 4, tickets: 5 }, { id: 5, tickets: 5 }] },
    { id: 9, name: "Sân Điện Biên Phủ", type: "Thảm PVC", tickets: 5, open: "05:30", close: "22:30", image: "img/thanhkhe4.png", district: "Thanh Khê", price: "80.000", monthPrice: 600000, subCourts: [{ id: 1, tickets: 5 }, { id: 2, tickets: 5 }, { id: 3, tickets: 5 }, { id: 4, tickets: 5 }, { id: 5, tickets: 5 }] },
    { id: 10, name: "Sân Sỹ Quan", type: "Sàn Gỗ", tickets: 5, open: "06:30", close: "23:00", image: "img/thanhkhe5.png", district: "Thanh Khê", price: "100.000", monthPrice: 720000, subCourts: [{ id: 1, tickets: 5 }, { id: 2, tickets: 5 }, { id: 3, tickets: 5 }, { id: 4, tickets: 5 }, { id: 5, tickets: 5 }] },
    // Sơn Trà
    { id: 11, name: "Sân Sơn Trà Star", type: "Sàn Gỗ", tickets: 5, open: "06:00", close: "23:00", image: "img/sontra1.png", district: "Sơn Trà", price: "100.000", monthPrice: 800000, subCourts: [{ id: 1, tickets: 5 }, { id: 2, tickets: 5 }, { id: 3, tickets: 5 }, { id: 4, tickets: 5 }, { id: 5, tickets: 5 }] },
    { id: 12, name: "Sân Hoàng Sa", type: "Thảm PVC", tickets: 5, open: "05:00", close: "22:00", image: "img/sontra2.png", district: "Sơn Trà", price: "80.000", monthPrice: 620000, subCourts: [{ id: 1, tickets: 5 }, { id: 2, tickets: 5 }, { id: 3, tickets: 5 }, { id: 4, tickets: 5 }, { id: 5, tickets: 5 }] },
    { id: 13, name: "Sân Mân Thái", type: "Thảm Su", tickets: 5, open: "04:30", close: "21:00", image: "img/sontra3.png", district: "Sơn Trà", price: "80.000", monthPrice: 600000, subCourts: [{ id: 1, tickets: 5 }, { id: 2, tickets: 5 }, { id: 3, tickets: 5 }, { id: 4, tickets: 5 }, { id: 5, tickets: 5 }] },
    { id: 14, name: "Sân Phạm Văn Đồng", type: "Thảm PVC", tickets: 5, open: "05:30", close: "23:30", image: "img/sontra4.png", district: "Sơn Trà", price: "80.000", monthPrice: 650000, subCourts: [{ id: 1, tickets: 5 }, { id: 2, tickets: 5 }, { id: 3, tickets: 5 }, { id: 4, tickets: 5 }, { id: 5, tickets: 5 }] },
    { id: 15, name: "Sân Đông", type: "Sàn Gỗ", tickets: 5, open: "05:00", close: "22:30", image: "img/sontra5.png", district: "Sơn Trà", price: "100.000", monthPrice: 750000, subCourts: [{ id: 1, tickets: 5 }, { id: 2, tickets: 5 }, { id: 3, tickets: 5 }, { id: 4, tickets: 5 }, { id: 5, tickets: 5 }] },
    // Liên Chiểu
    { id: 16, name: "Sân Bách Khoa", type: "Thảm PVC", tickets: 5, open: "05:00", close: "23:00", image: "img/lienchieu1.png", district: "Liên Chiểu", price: "80.000", monthPrice: 500000, subCourts: [{ id: 1, tickets: 5 }, { id: 2, tickets: 5 }, { id: 3, tickets: 5 }, { id: 4, tickets: 5 }, { id: 5, tickets: 5 }] },
    { id: 17, name: "Sân Nguyễn Lương Bằng", type: "Sàn Gỗ", tickets: 5, open: "06:00", close: "22:00", image: "img/lienchieu2.png", district: "Liên Chiểu", price: "100.000", monthPrice: 700000, subCourts: [{ id: 1, tickets: 5 }, { id: 2, tickets: 5 }, { id: 3, tickets: 5 }, { id: 4, tickets: 5 }, { id: 5, tickets: 5 }] },
    { id: 18, name: "Sân Kinh Doanh", type: "Thảm Su", tickets: 5, open: "04:30", close: "21:00", image: "img/lienchieu6.png", district: "Liên Chiểu", price: "80.000", monthPrice: 550000, subCourts: [{ id: 1, tickets: 5 }, { id: 2, tickets: 5 }, { id: 3, tickets: 5 }, { id: 4, tickets: 5 }, { id: 5, tickets: 5 }] },
    { id: 19, name: "Sân Hòa Khánh", type: "Thảm PVC", tickets: 5, open: "05:30", close: "23:00", image: "img/lienchieu4.png", district: "Liên Chiểu", price: "80.000", monthPrice: 600000, subCourts: [{ id: 1, tickets: 5 }, { id: 2, tickets: 5 }, { id: 3, tickets: 5 }, { id: 4, tickets: 5 }, { id: 5, tickets: 5 }] },
    { id: 20, name: "Sân Đà Nẵng Tây", type: "Sàn Gỗ", tickets: 5, open: "05:00", close: "22:30", image: "img/lienchieu7.png", district: "Liên Chiểu", price: "100.000", monthPrice: 720000, subCourts: [{ id: 1, tickets: 5 }, { id: 2, tickets: 5 }, { id: 3, tickets: 5 }, { id: 4, tickets: 5 }, { id: 5, tickets: 5 }] },
    // Cẩm Lệ
    { id: 21, name: "Sân Cẩm Lệ Mới", type: "Thảm PVC", tickets: 5, open: "05:00", close: "22:00", image: "img/camle1.png", district: "Cẩm Lệ", price: "80.000", monthPrice: 500000, subCourts: [{ id: 1, tickets: 5 }, { id: 2, tickets: 5 }, { id: 3, tickets: 5 }, { id: 4, tickets: 5 }, { id: 5, tickets: 5 }] },
    { id: 22, name: "Sân Tuyên Sơn", type: "Sàn Gỗ", tickets: 5, open: "06:00", close: "23:00", image: "img/camle5.png", district: "Cẩm Lệ", price: "100.000", monthPrice: 720000, subCourts: [{ id: 1, tickets: 5 }, { id: 2, tickets: 5 }, { id: 3, tickets: 5 }, { id: 4, tickets: 5 }, { id: 5, tickets: 5 }] },
    { id: 23, name: "Sân Phan Đăng Lưu", type: "Thảm Su", tickets: 5, open: "04:30", close: "21:00", image: "img/camle6.png", district: "Cẩm Lệ", price: "80.000", monthPrice: 550000, subCourts: [{ id: 1, tickets: 5 }, { id: 2, tickets: 5 }, { id: 3, tickets: 5 }, { id: 4, tickets: 5 }, { id: 5, tickets: 5 }] },
    { id: 24, name: "Sân Nguyễn Hữu Thọ", type: "Thảm PVC", tickets: 5, open: "05:30", close: "23:30", image: "img/camle2.png", district: "Cẩm Lệ", price: "80.000", monthPrice: 600000, subCourts: [{ id: 1, tickets: 5 }, { id: 2, tickets: 5 }, { id: 3, tickets: 5 }, { id: 4, tickets: 5 }, { id: 5, tickets: 5 }] },
    { id: 25, name: "Sân Hòa Xuân", type: "Sàn Gỗ", tickets: 5, open: "05:00", close: "22:30", image: "img/camle3.png", district: "Cẩm Lệ", price: "100.000", monthPrice: 750000, subCourts: [{ id: 1, tickets: 5 }, { id: 2, tickets: 5 }, { id: 3, tickets: 5 }, { id: 4, tickets: 5 }, { id: 5, tickets: 5 }] },
];
...
document.addEventListener('DOMContentLoaded', function() {
            ...
            card.innerHTML = `
                ...
                <div class="court-info">
                    ...
                    <div class="court-details">
                        ...
                        <span class="detail-item"> Sân Còn: <b>${currentTicketsCount}</b></span>
                    </div>
    ...
    if (payNowBtn) {
        payNowBtn.addEventListener("click", () => {
            ...
            if (pay_ticketType) pay_ticketType.textContent = ticketTypeValue === 'month' ? ' Tháng' : ' Giờ';
    ...
    // =========================================================
    // PHẦN QUAN TRỌNG: XỬ LÝ XÁC NHẬN THANH TOÁN & LƯU SỐ SÂN TRỐNG
    // =========================================================
    if (confirmBtn) {
        confirmBtn.addEventListener("click", () => {
            ...
            // 1. Cập nhật số vé trên allCourts và tính số sân còn trống
            ...
            if (courtIndex !== -1) {
                ...
                remainingAfterBooking = allCourts[courtIndex].tickets;
                saveCourtsData(allCourts); // Lưu trạng thái mới vào LocalStorage
            }
            ...
            const newBooking = {
                ...
                sanConTrong: remainingAfterBooking // Lưu số lượng sân còn lại vào đây
            };

            // 3. Lưu lịch sử đặt sân
